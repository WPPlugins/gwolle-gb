	...
	if ( isset($_POST['gwolle_gb_function']) && $_POST['gwolle_gb_function'] == 'add_entry' ) {
		...
		if ( $isspam ) {
			...
			if (get_option( 'gwolle_gb-refuse-spam', 'false') == 'true') {
				gwolle_gb_add_message( '<p class="refuse-spam-akismet"><strong>' . __('Your entry was marked as spam. Please try again.', 'gwolle-gb') . '</strong></p>', true, false );
				return false;
			}
		}
		...
		if ( isset($_POST["gwolle_gb_subject"]) && strlen($_POST["gwolle_gb_subject"]) > 0 ) {
			...
			if (get_option( 'gwolle_gb-refuse-spam', 'false') == 'true') {
				gwolle_gb_add_message( '<p class="refuse-spam-honeypot"><strong>' . __('Your entry was marked as spam. Please try again.', 'gwolle-gb') . '</strong></p>', true, false );
				return false;
			}
		}
		...
		if (get_option( 'gwolle_gb-nonce', 'true') == 'true') {
			...
			if ( $verified == false ) {
				...
				if (get_option( 'gwolle_gb-refuse-spam', 'false') == 'true') {
					gwolle_gb_add_message( '<p class="refuse-spam-nonce"><strong>' . __('Your entry was marked as spam. Please try again.', 'gwolle-gb') . '</strong></p>', true, false );
					return false;
				}
			}
		}
