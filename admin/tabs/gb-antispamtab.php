...
function gwolle_gb_page_settingstab_antispam() {
	...
	<table class="form-table">
		...
		<tr valign="top">
			<th scope="row"><label for="refuse-spam"><?php /* translators: Settings page, option for refusing spam */ _e('Refuse Spam', 'gwolle-gb'); ?></label></th>
			<td>
				<input <?php
				...
				<label for="refuse-spam">
					<?php _e('Refuse spam when recognized.', 'gwolle-gb'); ?>
				</label>
				<br />
				<span class="setting-description">
					<?php _e('Entries that are marked as spam will be placed in your spam folder by default.', 'gwolle-gb'); ?>
					<br />
					<?php _e('This option will refuse to accept entries marked by Honeypot, Nonce and Akismet. Users will see the form again after submit, with an error stating that it is recognized as spam.', 'gwolle-gb'); ?>
				</span>
			</td>
		</tr>
			...
			<td>
				<span class="setting-description">
					...
					if ( ! in_array('akismet/akismet.php', $current_plugins)) {
						...
						_e('Akismet is an external service by Automattic that acts as a spamfilter for guestbook entries.', 'gwolle-gb') . '<br />';
		...
		<tr valign="top">
			...
			<td>
				<div>
					<label for="antispam-question" class="setting-description"><?php _e('Custom security question to battle spam:', 'gwolle-gb'); ?></label><br />
					<input name="antispam-question" type="text" id="antispam-question" value="<?php echo $antispam_question; ?>" class="regular-text" placeholder="<?php _e('12 + six =', 'gwolle-gb'); ?>" /><br />
					<label for="antispam-answer" class="setting-description"><?php _e('The answer to your security question:', 'gwolle-gb'); ?></label><br />
					<input name="antispam-answer" type="text" id="antispam-answer" value="<?php echo $antispam_answer; ?>" class="regular-text" placeholder="<?php _e('18', 'gwolle-gb'); ?>" /><br />
