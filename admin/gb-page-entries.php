								...
								if ( get_option('gwolle_gb-showEntryIcons', 'true') === 'true' ) {
									$html_output .= '
										<td class="entry-icons">
											...
											<span class="trash-icon" title="' . /* translators: Is in Trashcan */ __('In Trash', 'gwolle-gb') . '""></span>';
