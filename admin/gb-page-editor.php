...
function gwolle_gb_editor_postbox_content() {
	global $entry;
	?>
	<textarea rows="10" name="gwolle_gb_content" id="gwolle_gb_content" class="wp-exclude-emoji" tabindex="1" placeholder="<?php _e('Message', 'gwolle-gb'); ?>"><?php echo gwolle_gb_sanitize_output( $entry->get_content(), 'content' ); ?></textarea>
	<?php
...
function gwolle_gb_editor_postbox_admin_reply() {
	...
	<textarea rows="10" name="gwolle_gb_admin_reply" id="gwolle_gb_admin_reply" class="wp-exclude-emoji" tabindex="4" placeholder="<?php _e('Admin Reply', 'gwolle-gb'); ?>"><?php echo gwolle_gb_sanitize_output( $entry->get_admin_reply(), 'admin_reply' ); ?></textarea>
...
function gwolle_gb_editor_postbox_icons() {
	...
	if ( get_option('gwolle_gb-showEntryIcons', 'true') === 'true' ) { ?>
		<span class="entry-icons <?php echo $class; ?>">
			...
			<span class="trash-icon" title="<?php /* translators: Is in Trashcan */ _e('In Trash', 'gwolle-gb'); ?>"></span>
			<?php
	...
	if ( $entry->get_id() == 0 ) {
		...
		<label for="istrash" class="selectit">
			<input id="istrash" name="istrash" type="checkbox" <?php
				...
				?> />
			<?php /* translators: Is in Trashcan */ _e('In Trash', 'gwolle-gb'); ?>
		</label>
	...
	if ( $entry->get_id() > 0 ) {
		...
		<p class="gwolle_gb_actions ' . $class . '">
			...
			<span class="gwolle_gb_trash">&nbsp;|&nbsp;
				<a id="trash_' . $entry->get_id() . '" href="#" class="vim-d vim-destructive" title="' . __('Move entry to trash.', 'gwolle-gb') . '">' . /* translators: Move to Trashcan */ __('Trash', 'gwolle-gb') . '</a>
			</span>
