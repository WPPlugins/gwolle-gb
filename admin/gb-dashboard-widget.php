				...
				<div class="dashboard-comment-wrap">
					...
					<p class="row-actions" id="entry-actions-<?php echo $entry->get_id(); ?>">
						...
						<span class="gwolle_gb_trash">
							&nbsp;|&nbsp;
							<a id="trash_<?php echo $entry->get_id(); ?>" href="#" class="vim-d vim-destructive" title="<?php _e('Move entry to trash.', 'gwolle-gb'); ?>"><?php /* translators: Move to Trashcan */ _e('Trash', 'gwolle-gb'); ?></a>
						</span>
